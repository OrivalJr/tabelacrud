...
import { listEstruturas } from "../../queries";
import {
  createCondominio,
  updateCondominio,
  updateEstrutura,
...
export default function CondominioCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setEstrutura(initialValues.Estrutura);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            condominioEstruturaId: modelFields?.Estrutura?.id,
          };
          const condominio = (
            await client.graphql({
            ...
            promises.push(
              client.graphql({
                ...
                variables: {
                  input: {
                    id: Estrutura.id,
                    estruturaCondominioId: condominio.id,
                  },
                },
              })
            );
